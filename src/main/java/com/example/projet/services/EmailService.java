...
<head>
    ...
    <style>
        ...
        .button { display: inline-block; padding: 14px 28px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; text-align: center; margin: 20px 0; }
        .link-box { background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 4px; padding: 15px; margin: 20px 0; word-break: break-all; }
        .link-text { color: #2563eb; font-size: 14px; }
        .important { background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 12px; margin: 20px 0; border-radius: 4px; }
...
<body>
    <div class="container">
        <div class="header">
            <img src="https://emnamnejja6.github.io/front-tunisiamed/assets/TunisiaMed.png" alt="TunisiaMed" class="logo">
        </div>
        ...
        <div class="footer">
            <p>© 2026 TunisiaMed. All rights reserved.</p>
                ...
                """, firstName, lastName, viewOffersUrl, viewOffersUrl);
...
<head>
    ...
    <style>
        ...
        .content { margin-bottom: 30px; }
        .button { display: inline-block; padding: 14px 28px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; text-align: center; margin: 20px 0; }
        .highlight { background-color: #d1fae5; border-left: 4px solid #10b981; padding: 15px; margin: 20px 0; border-radius: 4px; }
        .footer { text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 14px; }
    </style>
</head>
<body>
